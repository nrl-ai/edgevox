...
# Vendored from sgl-project/sglang python/sglang/srt/function_call/qwen25_detector.py
    ...
    def detect_and_parse(self, text: str, tools: list[Tool]) -> StreamingParseResult:
        ...
        for match_result in match_result_list:
            try:
                ...
                # share ``<tool_call>`` markers. Log at DEBUG so the chain stays quiet.
                logger.debug(f"qwen25 skipped non-JSON body: {match_result}, {e!s}")
                continue
